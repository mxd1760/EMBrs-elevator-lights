...
1. make sure you have [probe-rs](https://probe.rs/) setup on your system to help rust find your connected physical or emulated device.
2. clone or copy the repo to a location on your computer
3. run '''rustup target add thumbv7em-none-eabihf''' to add the embedded target
4. be sure to plug in an appropirate device to build to.
